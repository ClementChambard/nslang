...
lib fn NumLiteralParser::init(self: NumLiteralParser*, tok: Token*) init;
...
lib fn CharLiteralParser::init(self: CharLiteralParser*, tok: Token*) init;
...
lib fn StringLiteralParser::init(self: StringLiteralParser*, string_toks: Token**, string_toks_count: i64, eval_method: bool) init;
